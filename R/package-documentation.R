...
#' \cr
#' \cr
#' The aim of the ectotemp package is to facilitate easy and rapid estimation of 
#' small, terrestrial ectotherm temperature regulation effectiveness after data 
#' describing field-active body temperatures (Tb), environmental (operative) 
#' temperatures (Te) and preferred temperatures (the set-point range, Tset) have 
#' been collected. The package provides functions for the following types of 
#' analyses:
#' \itemize{
#'   \item The \bold{accuracy of temperature regulation (db)} and associated 
#'   descriptive statistics, which estimate the degree to which ectotherms 
#'   experience body temperature outside of their set-point range;
#'   \item The \bold{thermal quality of the habitat (de)} and associated 
...
#'   temperature regulation (E)}, including bootstrap resampling of the original 
#'   distributions of Tb and Te to determine confidence interval for the mean, 
#'   and permutation tests for between-population or species comparisons;
#'   \item \bold{Exploitation of the thermal environment (Ex)}, i.e., the amount 
#'   of time when field body temperatures (Tb) are within the set-point range, 
#'   relative to the total amount of time during which this could have been 
#'   possible as indicated by operative temperatures (Te). 
#' }
#' 
#' @seealso 
#' Useful links:
